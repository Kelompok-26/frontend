      ...
      <table class="w-3/4 text-left text-black min-h-fit">
        <thead class="uppercase">
          <tr>
            ...
            <th scope="col" class="px-12 py-6">Provider</th>
            <th scope="col" class="px-12 py-6">Paket Data</th>
            <th scope="col" class="px-12 py-6">Harga</th>
            <th scope="col" class="px-12 py-6">Jumlah</th>
            <th scope="col" class="px-12 py-6">Point</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-12 py-4">{{ val.provider_name }}</td>
            <td class="px-12 py-4">{{ val.product_name }}</td>
            <td class="px-12 py-4">{{ val.nominal}}</td>
            <td class="px-12 py-4">{{ val.stock}}</td>
            <td class="px-12 py-4">{{ val.point}}</td>
